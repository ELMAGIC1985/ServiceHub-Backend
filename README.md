...
3. **Download the Necessary Files:**
   Click the assets section below the latest release and download the appropriate file for your system.

4. **Install the Application:**
   Open the downloaded file and follow the on-screen instructions to install the application on your system.

5. **Run the Application:**
   Once installation is complete, run the application. You can find it in your applications or programs list.
